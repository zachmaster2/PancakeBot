...
5. Expand the profile-window selector beyond `stageB` vs one `flow Bear` profile, while keeping actual runtime contained until a broader controller qualifies.
