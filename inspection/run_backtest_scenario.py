...
def _runtime_cfg_from_app(cfg) -> RuntimeConfig:
    ...
    return RuntimeConfig(
        ...
        event_freshness_slack_seconds=int(cfg.event_freshness_slack_seconds),
        ...
        predictability_gate_enabled=bool(cfg.predictability_gate_enabled),
        predictability_gate_threshold=float(cfg.predictability_gate_threshold),
