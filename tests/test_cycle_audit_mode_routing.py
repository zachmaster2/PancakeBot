...
def test_cycle_audit_logs_actual_fetch_fire_time(tmp_path, monkeypatch):
    ...
    for dry, path in ((True, dry_path), (False, live_path)):
        ...
        _record_cycle_audit(
            ...
            current_epoch=386441, locked_epoch=386440, lock_ts=1790411538, cutoff_ts=1790411536,
...
def test_live_bet_writes_cycle_audit_row(tmp_path, monkeypatch):
    ...
    _record_cycle_audit(
        ...
        open_round=None,
        bankroll_before_action_bnb=2.5,   # live: pre-bet wallet read
    ...
    assert float(r["bankroll_before_action_bnb"]) == 2.5
