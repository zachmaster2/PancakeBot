...
The corrected picture:
  ...
  * At the live bankroll of ~1.9 BNB the OLD 0.1 absolute cap bound 0
...
LIVE_BANKROLL = 1.9            # ledger at the time of the change, rounded
...
def test_at_the_live_bankroll_the_old_absolute_cap_never_bound(
    ...
    """0.05 x 1.9 = 0.095 < 0.10, so under the old cap the bankroll
    fraction (or the raw size) always won. This is why observed live stakes
    sat at 0.095 and never at 0.1000."""
    for fire in fires:
